...
<body>
	...
	<div class="right-side-cart-area">
		...
		<div class="cart-button">
			<a href="#" id="rightSideCart"><img src="${pageContext.request.contextPath}/res/img/core-img/bag.svg"
				alt=""/><span>3</span></a>
		</div>
			...
			<div class="cart-list">
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/res/img/product-img/product-1.jpg" class="cart-thumb" alt=""/>
							<!-- Cart Item Desc -->
					<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"><!--  Some content -->.</i></span><span class="badge">Mango</span>
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/res/img/product-img/product-2.jpg" class="cart-thumb" alt=""/>
							<!-- Cart Item Desc -->
					<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"><!--  Some content -->.</i></span> <span class="badge">Mango</span>
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/res/img/product-img/product-3.jpg" class="cart-thumb" alt=""/>
							<!-- Cart Item Desc -->
					<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"><!--  Some content -->.</i></span> <span class="badge">Mango</span>
					...
					<div class="popular-products-slides owl-carousel">
						...
						<div class="single-product-wrapper">
							...
							<div class="product-img">
								<img src="${pageContext.request.contextPath}/res/img/product-img/product-1.jpg" alt=""/> <!-- Hover Thumb --><img
									class="hover-img" src="${pageContext.request.contextPath}/res/img/product-img/mj_thriller.jpg" alt=""/>
									<!-- Favourite -->
								<div class="product-favourite">
									<a href="#" class="favme fa fa-heart"><!--  Some content -->.</a>
								</div>
							</div>
							<!-- Product Description -->
						...
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="${pageContext.request.contextPath}/res/img/product-img/product-2.jpg" alt=""/> <!-- Hover Thumb --><img
									class="hover-img" src="${pageContext.request.contextPath}/res/img/product-img/ACDC_BackInBlack.jpg"
									alt=""/> <!-- Favourite -->
								<div class="product-favourite">
									<a href="#" class="favme fa fa-heart"><!--  Some content -->.</a>
								</div>
						...
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="${pageContext.request.contextPath}/res/img/product-img/product-3.jpg" alt=""/> <!-- Hover Thumb --><img
									class="hover-img" src="${pageContext.request.contextPath}/res/img/product-img/bat_out_of_hell.jpg"
									alt=""/> <!-- Product Badge -->
						...
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="${pageContext.request.contextPath}/res/img/product-img/product-4.jpg" alt=""/> <!-- Hover Thumb --><img
									class="hover-img"
									src="${pageContext.request.contextPath}/res/img/product-img/Roddy-Ricch-Antisocial.jpg" alt=""/>
	...
	<div
		...
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand1.png" alt=""/>
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand2.png" alt=""/>
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand3.png" alt=""/>
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand4.png" alt=""/>
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand5.png" alt=""/>
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img src="${pageContext.request.contextPath}/res/img/core-img/brand6.png" alt=""/>
		</div>
	</div>
	<!-- ##### Brands Area End ##### -->
