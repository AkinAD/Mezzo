    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="Home.jsp"><img src="${pageContext.request.contextPath}/res/img/core-img/logo.png" alt=""/></a>
                <!-- Navbar Toggler -->
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="search-area">
                    <form action="#" method="post">
                        ...
                        <button type="submit"><i class="fa fa-search" aria-hidden="true"><!-- some content -->.</i></button>
                    </form>
                </div>
                <!-- Favourite Area -->
                ...
                <div class="user-login-info">
                    <a href="login"><img src="${pageContext.request.contextPath}/res/img/core-img/user.svg" alt=""/></a>
                </div>
                <!-- Cart Area -->
                <div class="cart-area">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        ...
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"><!--  Some content -->.</i></span>
                        ...
                        <form action="#" method="post">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="first_name" value="" required="required"/><!-- REQURED DOES NOT NEED A VALUE, BUT JSP WILL COMPLAIN OTHERWISE  -->
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="custom-control custom-checkbox d-block mb-2">
                                        ...
                                        <!-- THIS IS WHERE YOU ADD THE COMMANDS TO CREATE ACCOUNT .. I THINK -->
                                    </div>
				...
				<div class="col-12 col-md-6">
					<div class="single_widget_area d-flex mb-30">
						...
						<div class="footer-logo mr-50">
							<a href="#"><img
								src="${pageContext.request.contextPath}/res/img/core-img/logo2.png"
								alt="" /></a>
						</div>
						<!-- Footer Menu -->
