...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/open-iconic-bootstrap.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/animate.css" />

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/owl.carousel.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/owl.theme.default.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/magnific-popup.css" />

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/aos.css" />

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/ionicons.min.css" />
<link rel="stylesheet"
...
<body>
									...
									<tr class="text-center">
										<td class="product-remove">
											<form>
												<INPUT name="addToCart" type="hidden"
													value="${current.item.aid}" />
												<button name="delete" value="delete" type="submit">
													<span class="fa fa-close" aria-hidden="true"> <!--  Some content -->&#160;
													</span>
												</button>
											</form>
										</td>
										...
										<div class="cart-item-desc">
											<td class="product-image"><a
												href="${pageContext.request.contextPath}/ProductPage?aid=${current.item.aid}">
													<c:url var="myurl" value="${current.item.picture}" /> <img
													src="${myurl}" class="cart-thumb" alt=""
													style="width: 50%;" />
											</a></td>
										</div>
										...
										<td class="price"><f:setLocale value="en_CA" /> <f:formatNumber
												value="${current.item.price}" type="currency" /></td>
										<td class="quantity">
											<form action="" class="number-input">
												...
												<input name="quantity" type="number"
													class="cartItemQuantity" min="1" step="1"
													value="${current.qty}" />
										...
										<td class="total"><f:setLocale value="en_CA" /> <f:formatNumber
									value="${current.effectivePrice}" type="Currency"/> </td>
									</tr>
									<!-- END TR-->
								</c:forEach>
			...
			<div class="row justify-content-end">
				<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
					<div class="cart-total mb-3">
						<h3>Cart Totals</h3>
						<p class="d-flex">
							<span>Subtotal</span> <span><f:setLocale value="en_CA" />
								<f:formatNumber value="${requestScope.cartTotal}"
									type="currency" /></span>
						</p>
						<p class="d-flex">
	...
	<script src="${pageContext.request.contextPath}/res/js/cart.js">
		;
	</script>
